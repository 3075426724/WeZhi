...
module.exports = {
	...
	// 健康监测
	'health/my_list': 'health_controller@getMyHealthList',
	'health/insert': 'health_controller@insertHealth',
	'health/detail': 'health_controller@getHealthDetail',
	'health/edit': 'health_controller@editHealth',
	'health/del': 'health_controller@delHealth',
	'health/health_update_forms': 'health_controller@updateHealthForms',

	'admin/health_list': 'admin/admin_health_controller@getAdminHealthList',
	'admin/health_detail': 'admin/admin_health_controller@getHealthDetail',
	'admin/health_del': 'admin/admin_health_controller@delHealth#demo',  
	'admin/health_data_get': 'admin/admin_health_controller@healthDataGet',
	'admin/health_data_export': 'admin/admin_health_controller@healthDataExport',
	'admin/health_data_del': 'admin/admin_health_controller@healthDataDel',
