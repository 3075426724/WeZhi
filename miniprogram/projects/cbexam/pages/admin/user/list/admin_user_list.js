...
Page({
	...
	_getSearchMenu: async function () {
		...
		let sortItems1 = [
			...
			{ label: '答题次数▽', type: 'sort', value: 'USER_ANSWER_CNT|desc' },
			{ label: '答题次数△', type: 'sort', value: 'USER_ANSWER_CNT|asc' },

			{ label: '答题得分▽', type: 'sort', value: 'USER_ANSWER_SCORE|desc' },
			{ label: '答题得分△', type: 'sort', value: 'USER_ANSWER_SCORE|asc' },
		];
		let sortMenus = [
			{ label: '全部', type: '', value: '' },
