	...
	async mockEnrollJoin() {
		...
		for (let k in list) {
			...
			for (let j = 0; j < step; j++) {
				...
				data.ENROLL_JOIN_DAY = fakerLib.getDate('2023-06-10', '2023-06-13', 'Y-M-D')
			...
			let userList = [];
			userList.push({
				id: global.PID + '_' + fakerLib.getIntBetween(1, 48),
				name: fakerLib.getName(),
				pic: fakerLib.getAvatar()
			},
				{
					id: global.PID + '_' + fakerLib.getIntBetween(1, 48),
					name: fakerLib.getName(),
